...
export default {
  ...
  async mounted(){
    ...
    await axios.get('http://localhost:81/admin/api/rezervasyon/thisday')
    .then((res) =>{
     ...
     await axios.get('http://localhost:81/admin/api/rezervasyon/thismonth')
    .then((res) =>{
     ...
     await axios.get('http://localhost:81/admin/api/rezervasyon/thisyear')
    .then((res) =>{
